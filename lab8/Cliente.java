...
public class Cliente implements Emissor {
    ...
    public double fazerPedido(Conveniado deOnde, boolean queroDesconto){
        ...
        if(queroDesconto){
            ...
            System.out.println("Pedido feito s/ desc - total: " + total);
            engajamento += 10;
            return total;
        }
    ...
    private void setDesconto(){
        desconto = engajamento * 0.3;
    }

    @Override
    public void notificarObservador(lazyObserver o) {
        o.atualizar(desconto);
    }
}
